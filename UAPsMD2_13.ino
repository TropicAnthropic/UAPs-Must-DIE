...
//Move Bullets
    ...
    if (bulletexist[1] == 1)
    {
      bulletx[1] = bulletx[1] + 6;
      bullety[1] = bullety[1] - 3;
    ...
    if (bulletexist[2] == 1)
    {
      bulletx[2] = bulletx[2] + 6;
      bullety[2] = bullety[2] - 3;
    ...
    if (bulletexist[3] == 1)
    {
      bulletx[3] = bulletx[3] + 6;
      bullety[3] = bullety[3] - 3;
...
// Spawn UAPs *****************************
int r = rand() % 3000; // Rate at which UAPs Spawn
  ...
  else
{
  if (UAPexist[1] == 1)
  {
    ...
    int r = rand() % 300; // Randomly initiate Enemy bullets
    {
      if (r < 5)
      {
